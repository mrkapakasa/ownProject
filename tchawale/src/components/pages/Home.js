...
<section className="container mx-auto px-4 py-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
  <div className="bg-yellow-100 p-2 rounded-lg shadow hover:shadow-lg transition">
    ...
    <p className="text-sm text-yellow-600">Find assignments, study materials, and more.</p>
    <Link 
      to="/student-resources" 
      className="mt-4 inline-block bg-yellow-700 text-white text-sm font-medium py-2 px-4 rounded hover:bg-yellow-800 transition"
    >
      Explore Resources
    </Link>
  </div>
  ...
  <h2 className="text-lg font-semibold text-green-700">Teacher Portal</h2>
  <p className="text-sm text-green-600">Access lesson plans and grading tools.</p>
  
  {/* Button to navigate to Teacher's Portal */}
  <Link
    to="/teachers-portal" // Route to Teacher's Portal page
    className="mt-4 inline-block bg-green-700 text-white text-sm font-medium py-2 px-4 rounded hover:bg-green-800 transition"
  >
    Explore Portal
  </Link>
</div>
        ...
        <div className="bg-red-100 p-2 rounded-lg shadow hover:shadow-lg transition">
          <h2 className="text-lg font-semibold text-red-700">Parent Dashboard</h2>
          <p className="text-sm text-red-600">View student progress and school updates.</p>
        </div>
      </section>
